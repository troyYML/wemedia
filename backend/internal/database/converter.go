...
func ConvertToDBArticle(art *appmodels.Article, accountID uint) *models.Article {
	return &models.Article{
		...
		Digest:           art.Digest,
		Content:          art.Content,
		CleanContent:     art.CleanContent,
		ImageLinks:       art.ImageLinks,
		HitKeywords:      art.HitKeywords,
...
func ConvertToAppArticle(dbArt *models.Article) appmodels.Article {
	return appmodels.Article{
		...
		CleanContent:     dbArt.CleanContent,
		ImageLinks:       dbArt.ImageLinks,
		HitKeywords:      dbArt.HitKeywords,
